...
var MobileMenu = function () {
  function MobileMenu() {
    ...
    this.menuIcon = (0, _jquery2.default)(".site-header__menu-icon"); //DOM element
  ...
  _createClass(MobileMenu, [{
    ...
    value: function events() {
      this.menuIcon.click(this.toggleTheMenu.bind(this)); // On event do somethibg
    }
  }, {
    key: "toggleTheMenu",
...
var mobileMenu = new _MobileMenu2.default(); /* After  */
